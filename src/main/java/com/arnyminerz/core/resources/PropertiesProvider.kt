...
import com.arnyminerz.core.utils.doAsync
...
abstract class PropertiesProvider(private val readOnly: Boolean) {
    ...
    /**
     * Returns the amount of properties currently loaded.
     */
    val size: Int
        get() = properties.size
    ...
    /**
     * Returns the current value for the given [key] or throws an exception if there is no such key in the map.
     * @throws NoSuchElementException If [key] is not currently stored.
     */
    fun getValue(key: String): String = properties.getValue(key)
